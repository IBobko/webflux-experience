...
public class SpringSSEConfigurations {
    ...
    private static final String BOOTSTRAP_SERVERS = "172.20.0.3:9092";
    ...
    public KafkaReceiver<String,String> kafkaReceiver(){
        ...
        return new DefaultKafkaReceiver<>(ConsumerFactory.INSTANCE, ReceiverOptions.<String, String>create(props).subscription(Collections.singleton(TOPIC)));
    }
}
